    ...
    return(<>
        <section className={`idea ${location !== '/' && 'ideaCatalog'}`}>
                    <div className="idea__wrapper wrapper">
                        ...
                        <img src={ideaRocket} alt="background rocket" className="idea__rocket-1" />
                        <img src={ideaLamp} alt="background rocket" className="idea__lamp" />
                        <img src={ideaRocket2} alt="background rocket" className="idea__rocket-2" />
                    </div>
        </section>
    </>)
}