        ...
        <div className="footer__wrapper wrapper">
            ...
            <div className="footer__menu">
                <ul className="footer__menu_container" id="footer__menu_container-first">
                    <li className="footer__menu_title">Категории</li>
                    <li className="footer__menu_item"><a href="./pages/index.html" className="footer__menu_link sub-text">Пошив</a></li>
                    <li className="footer__menu_item"><a href="./pages/index.html" className="footer__menu_link sub-text">Все товары</a></li>
                    <li className="footer__menu_item"><a href="./pages/index.html" className="footer__menu_link sub-text">Наборы</a></li>
                    <li className="footer__menu_item"><a href="./pages/index.html" className="footer__menu_link sub-text">Производство</a></li>
                </ul>
                <ul className="footer__menu_container" id="footer__menu_container-second">
                    <li className="footer__menu_title">Информация</li>
                    <li className="footer__menu_item"><a href="./pages/index.html" className="footer__menu_link sub-text">О нас</a></li>
                    <li className="footer__menu_item"><a href="./pages/index.html" className="footer__menu_link sub-text">ЧаВо</a></li>
                    <li className="footer__menu_item"><a href="./pages/index.html" className="footer__menu_link sub-text">Контакты</a></li>
                </ul>
            </div>
            <div className="footer__form">
                ...
                <p className="footer__form_subtitle">
                    Есть вопрос на который не нашли ответ? <span><br /></span>Оставьте контакт и наш менеджер свяжеться с
                    вами
                </p>
